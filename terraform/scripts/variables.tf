...
variable "proxy_image" {
  default = "id9ypxcsj7cu/proxy-webserver:v6.4"
}
variable "proxy-webserver-latest_container_image_ocid" {
  default = "ocid1.containerimage.oc1.iad.0.id9ypxcsj7cu.aaaaaaaaknrd7lzqznlpkcotd2xateiw4ccbsmar2fmxgwlmt6ravkhegalq"
}